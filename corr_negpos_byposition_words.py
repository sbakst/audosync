...
# optional
parser.add_argument("words", help = "word file")
...
wordfi = args.words
thesewords = open(wordfi)
words = thesewords.read()
...
for sign in si:
    ...
    vtp = ftp[(ftp.phone == 'AY1') |( ftp.phone == 'OW1')|( ftp.phone == 'AA1' )|( ftp.phone == 'IY1' )|( ftp.phone == 'AH0' )|( ftp.phone == 'AH1')| (ftp.phone == 'EH1')| ( ftp.phone == 'AE1')|(ftp.phone=='IH1')|(ftp.phone=='EY1')]
...
#    sns.scatterplot(x = "pos", y = "us_diff", hue = 'phone', marker = '+',data = vtp, ax = vtpp2)
    ...
    vtpp2 = vtpp.twinx()
    sns.scatterplot(x = "pos", y = "us_diff", hue = 'phone', marker = '+',data = vtp, ax = vtpp2)
    vtpp2.get_legend().set_visible(False)
...
#    ax6.legend(h2, l2, loc=3)
    ...
    figname = sign +'_onsets_test_legend' + testsubj + '_byposition_allp.png'
